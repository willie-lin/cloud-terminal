...
// SSHPublicKey applies equality check predicate on the "ssh_public_key" field. It's identical to SSHPublicKeyEQ.
func SSHPublicKey(v string) predicate.User {
	return predicate.User(sql.FieldEQ(FieldSSHPublicKey, v))
}
...
// SSHPublicKeyEQ applies the EQ predicate on the "ssh_public_key" field.
func SSHPublicKeyEQ(v string) predicate.User {
	return predicate.User(sql.FieldEQ(FieldSSHPublicKey, v))
}

// SSHPublicKeyNEQ applies the NEQ predicate on the "ssh_public_key" field.
func SSHPublicKeyNEQ(v string) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldSSHPublicKey, v))
}

// SSHPublicKeyIn applies the In predicate on the "ssh_public_key" field.
func SSHPublicKeyIn(vs ...string) predicate.User {
	return predicate.User(sql.FieldIn(FieldSSHPublicKey, vs...))
}

// SSHPublicKeyNotIn applies the NotIn predicate on the "ssh_public_key" field.
func SSHPublicKeyNotIn(vs ...string) predicate.User {
	return predicate.User(sql.FieldNotIn(FieldSSHPublicKey, vs...))
}

// SSHPublicKeyGT applies the GT predicate on the "ssh_public_key" field.
func SSHPublicKeyGT(v string) predicate.User {
	return predicate.User(sql.FieldGT(FieldSSHPublicKey, v))
}

// SSHPublicKeyGTE applies the GTE predicate on the "ssh_public_key" field.
func SSHPublicKeyGTE(v string) predicate.User {
	return predicate.User(sql.FieldGTE(FieldSSHPublicKey, v))
}

// SSHPublicKeyLT applies the LT predicate on the "ssh_public_key" field.
func SSHPublicKeyLT(v string) predicate.User {
	return predicate.User(sql.FieldLT(FieldSSHPublicKey, v))
}

// SSHPublicKeyLTE applies the LTE predicate on the "ssh_public_key" field.
func SSHPublicKeyLTE(v string) predicate.User {
	return predicate.User(sql.FieldLTE(FieldSSHPublicKey, v))
}

// SSHPublicKeyContains applies the Contains predicate on the "ssh_public_key" field.
func SSHPublicKeyContains(v string) predicate.User {
	return predicate.User(sql.FieldContains(FieldSSHPublicKey, v))
}

// SSHPublicKeyHasPrefix applies the HasPrefix predicate on the "ssh_public_key" field.
func SSHPublicKeyHasPrefix(v string) predicate.User {
	return predicate.User(sql.FieldHasPrefix(FieldSSHPublicKey, v))
}

// SSHPublicKeyHasSuffix applies the HasSuffix predicate on the "ssh_public_key" field.
func SSHPublicKeyHasSuffix(v string) predicate.User {
	return predicate.User(sql.FieldHasSuffix(FieldSSHPublicKey, v))
}

// SSHPublicKeyIsNil applies the IsNil predicate on the "ssh_public_key" field.
func SSHPublicKeyIsNil() predicate.User {
	return predicate.User(sql.FieldIsNull(FieldSSHPublicKey))
}

// SSHPublicKeyNotNil applies the NotNil predicate on the "ssh_public_key" field.
func SSHPublicKeyNotNil() predicate.User {
	return predicate.User(sql.FieldNotNull(FieldSSHPublicKey))
}

// SSHPublicKeyEqualFold applies the EqualFold predicate on the "ssh_public_key" field.
func SSHPublicKeyEqualFold(v string) predicate.User {
	return predicate.User(sql.FieldEqualFold(FieldSSHPublicKey, v))
}

// SSHPublicKeyContainsFold applies the ContainsFold predicate on the "ssh_public_key" field.
func SSHPublicKeyContainsFold(v string) predicate.User {
	return predicate.User(sql.FieldContainsFold(FieldSSHPublicKey, v))
}
...
func HasAccessPolicies() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasAccessPoliciesWith(preds ...predicate.AccessPolicy) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
// HasReviewedTasks applies the HasEdge predicate on the "reviewed_tasks" edge.
func HasReviewedTasks() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, ReviewedTasksTable, ReviewedTasksColumn),
		)
		schemaConfig := internal.SchemaConfigFromContext(s.Context())
		step.To.Schema = schemaConfig.Task
		step.Edge.Schema = schemaConfig.Task
...
// HasReviewedTasksWith applies the HasEdge predicate on the "reviewed_tasks" edge with a given conditions (other predicates).
func HasReviewedTasksWith(preds ...predicate.Task) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newReviewedTasksStep()
		schemaConfig := internal.SchemaConfigFromContext(s.Context())
		step.To.Schema = schemaConfig.Task
		step.Edge.Schema = schemaConfig.Task
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
