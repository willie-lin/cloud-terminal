...
const (
	...
	FieldPort = "port"
	// FieldResourceLimit holds the string denoting the resource_limit field in the database.
	FieldResourceLimit = "resource_limit"
...
func StatusValidator(s Status) error {
	...
	case StatusActive, StatusInactive:
		return nil
	default:
		return fmt.Errorf("environment: invalid enum value for status field: %q", s)
	}
}
