...
func (_q *EnvironmentQuery) QueryTenant() *TenantQuery {
...
func (_q *EnvironmentQuery) WithTenant(opts ...func(*TenantQuery)) *EnvironmentQuery {
	query := (&TenantClient{config: _q.config}).Query()
...
func (_q *EnvironmentQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Environment, error) {
	...
	_spec.Node.Schema = _q.schemaConfig.Environment
	...
	if query := _q.withTenant; query != nil {
		if err := _q.loadTenant(ctx, query, nodes, nil,
			func(n *Environment, e *Tenant) { n.Edges.Tenant = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *EnvironmentQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*Environment, init func(*Environment), assign func(*Environment, *Tenant)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*Environment)
	for i := range nodes {
		if nodes[i].tenant_environments == nil {
			continue
		}
		fk := *nodes[i].tenant_environments
...
func (_q *EnvironmentQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1.Schema(_q.schemaConfig.Environment)
	ctx = internal.NewSchemaConfigContext(ctx, _q.schemaConfig)
...
func (_q *EnvironmentQuery) ForUpdate(opts ...sql.LockOption) *EnvironmentQuery {
...
func (_q *EnvironmentQuery) ForShare(opts ...sql.LockOption) *EnvironmentQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
